 ...
 */
var Ty = User(name: "Ty", age: 25, weight: 135.5, height: 74, activityLevel: 7)
print(Ty)
...
let feetToMeters = Distance(feet: 5)
let metersToFeet = Distance(meters: 10)
/*:
 ...
 */
var centimneters = Distance(feet: 5)
