 ...
 */
func introduceMyself(yo intro: String, to intro2: String) {
    print("Hello I am \(intro) and I like \(intro2)")
}
introduceMyself(yo: "Ty", to: "Sauce")
/*:
 ...
 */
import Foundation
func magicEightBall(kek number: Int) {
