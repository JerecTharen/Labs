 ...
 */
// any = a type to have anything in it
var date = ["January": 31, "Febuary": 28, "March": 31]
print(date)
/*:
 ...
 */
if let oldDate = date.updateValue(31, forKey: "Janurary") {
...
let pasta = ["Circle": "red", "Square": "Green", "Traingle": "Blue"]
print(pasta)
 ...
 */
if let lastColor = pasta["Traingle"] {
    print(lastColor)
}
