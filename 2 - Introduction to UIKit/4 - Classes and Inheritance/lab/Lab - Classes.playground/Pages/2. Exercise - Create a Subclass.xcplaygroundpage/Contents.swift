...
let destroyer = Destroyer(laser: "pewpew")
destroyer.moveLeft()
destroyer.moveLeft()
 ...
 */
// print(falcon.weapon)
// I need to specify the subclass that has the var weapon as SpaceShip does not, i also have not set falcon to  = SpaceShip on this page.
