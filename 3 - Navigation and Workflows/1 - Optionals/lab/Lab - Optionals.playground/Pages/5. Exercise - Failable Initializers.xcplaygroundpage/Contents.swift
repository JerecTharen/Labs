 ...
 */
let computer1 = Computer(ram: 0, yearManufactured: 1955)
    if let computer2 = computer1 {
print(computer2.ram)
print(computer2.yearManufactured)
}

let computer3 = Computer(ram: 16, yearManufactured: 2016)
if let computer22 = computer1 {
    print(computer22.ram)
    print(computer22.yearManufactured)
}
