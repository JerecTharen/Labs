...
*/
func calculateArea(_ x: Double, multiplied y: Double) -> Double? {
...
calculateArea(4, multiplied: 6)
calculateArea(5, multiplied: 10)
...
func add(_ a: Int?, add b: Int?) -> Int? {
    guard let theA = a, let theB = b else {return nil}
    let sum = theA + theB
    print(sum)
    return sum
    }
