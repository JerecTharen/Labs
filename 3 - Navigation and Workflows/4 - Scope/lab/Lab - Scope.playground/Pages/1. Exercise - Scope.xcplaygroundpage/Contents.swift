...
//print("The value of foo is \(foo)")
// you got rid of the end of the loop, 0 in what. in 3. how many times????
...
func greeting(greeting: String?, name: String) {
    if let greeting = greeting {
        print("\(greeting) \(name), TIME 2 DYE")
        return
    }
}
var greet = greeting(greeting: "Oh hello", name: "JIM")
greet
/*:
...
let car = Car(make: "Jim", model: "Jam", year: 9)
print(car.make)
print(car.model)
print(car.year)
