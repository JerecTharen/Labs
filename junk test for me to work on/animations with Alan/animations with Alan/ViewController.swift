...
//  animations with Alan
//
//  Created by Tyler Donohue on 11/30/18.
...
//        }
        ...
        animation.values = [UIColor.red.cgColor, UIColor.yellow.cgColor, UIColor.orange.cgColor, UIColor.purple.cgColor, UIColor.red.cgColor]
